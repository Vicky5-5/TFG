...
public class Cuchillo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (handTransform != null && knife != null)
        {
            ...
            knife.transform.localPosition = new Vector3(1.549f, 0.066f, -0.825f); // Ajusta según el modelo
            knife.transform.localRotation = Quaternion.Euler(-8.1f, -151.9f, 0f); // Ajusta según el modelo
    ...
    private IEnumerator Attack()
    {
        ...
        {
            Debug.Log("El Raycast golpeó: " + hit.collider.name);
